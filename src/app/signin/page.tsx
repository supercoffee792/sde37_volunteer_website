                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-2">
                            ...
                            <input type="email" id="email" name="email" value={password}
                                ...
                                className="mt-1 text-white block w-full px-3 py-2 border bg-gray-900 border-blue-300 rounded-md shadow-sm focus:text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your email" required/>
                        </div>
